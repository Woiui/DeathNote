...
13:00之前跑990金币+699金币（预计跑完5-6次后0金币）
...
class _0x9d8dda {
  constructor(T) {
    ...
    this["cookie"] = "kpn=NEBULA; kpf=ANDROID_PHONE; did=ANDROID_841578964efb574a; ver=10.3; appver=10.3.40.2474; language=zh-cn; countryCode=CN; sys=ANDROID_9; client_key=2ac2a76d; " + p;
...
function Envcc(T, c) {
  const p = {
    ...
    'dceom': 'ijzfe',
    'JighY': 'updateMsg',
    'uwDzR': "https://ghproxy.com/https://raw.githubusercontent.com/Woiui/DeathNote/main/ks.json",
    'CvmUM': function (S, a) {
      return S === a;
    },
    'QfLFC': "JwVvM",
    ...
    [p["QrmhW"]](S, a) {
      if (p["JpIGP"]('ViWHE', p["NOwog"])) {
        if (p["QwtqA"](q, i[p["LTEld"]])) {
          d = true;
          u = "https://ghproxy.com/https://raw.githubusercontent.com/Woiui/DeathNote/main/ks.json";
